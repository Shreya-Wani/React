  ...
  return (
    <div className='parent'>
      {jobOpenings.map(function(elem, idx) {
        return <Card key={idx} company={elem.companyName} brandLogo={elem.brandLogo} datePosted={elem.datePosted} post={elem.post} tag1={elem.tag1} tag2={elem.tag2} pay={elem.pay} location={elem.location} />;
      })}
    </div>
  )
}
